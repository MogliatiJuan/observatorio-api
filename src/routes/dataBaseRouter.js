...
import DB_Controller from "../controllers/dataBaseController.js";
...
routerdataBase.get(
  "/all_Litigantes",
  DB_Controller.Query_Select_ListaLitigantes
);
...
routerdataBase.get(
  "/AUDIENCIASPERSONASMORE7DAYS",
  DB_Controller.audienciaspersonasMore7days
);

routerdataBase.get(
  "/AUDIENCIASPERSONASTIMEOUT",
  DB_Controller.audienciaspersonasTimeOut
);

routerdataBase.get(
  "/AUDIENCIASPERSONAS7DAYSANDTODAY",
  DB_Controller.audienciaspersonas7daysandToday
);

routerdataBase.get(
  "/JUICIOSPERSONASMORE7DAYS",
  DB_Controller.juiciospersonasMore7days
);

routerdataBase.get(
  "/JUICIOSPERSONASTIMEOUT",
  DB_Controller.juiciospersonasTimeOut
);

routerdataBase.get(
  "/JUICIOSPERSONAS7DAYSANDTODAY",
  DB_Controller.juiciospersonas7daysandToday
);
