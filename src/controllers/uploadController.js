const controller = {};
import funcionfechas from "./functionsController.js";
  ...
  if (req.file) {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : CD - RECIBIDA - ACTUALIZACION con Modificacion de Archivo"
        );
      });
    });
  } else {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : CD - RECIBIDA - ACTUALIZACION Dejando  el Archivo Existente"
        );
      });
    });
  }
  ...
  if (req.file) {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : CD - EMITIDA - ACTUALIZACION con Modificacion de Archivo"
        );
      });
    });
  } else {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : CD - EMITIDA - ACTUALIZACION Dejando  el Archivo Existente"
        );
      });
    });
  }
  ...
  if (req.file) {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : AUDIENCIA - ACTUALIZACION con Modificacion de Archivo"
        );
      });
    });
  } else {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : AUDIENCIA - ACTUALIZACION Dejando  el Archivo Existente"
        );
      });
    });
  }
  ...
  if (req.file) {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : JUICIO - ACTUALIZACION con Modificacion de Archivo"
        );
      });
    });
  } else {
    ...
    req.getConnection((err, conn) => {
      ...
      conn.query(actualizo, (err, result) => {
        ...
        console.log(
          "Monitor Servidor : JUICIO - ACTUALIZACION Dejando  el Archivo Existente"
        );
      });
    });
  }
